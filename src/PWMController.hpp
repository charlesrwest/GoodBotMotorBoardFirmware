...
#if STM32_PWM_USE_TIM1 && (STM32_PWM_USE_TIM3 || STM32_PWM_USE_TIM4 || STM32_PWM_USE_TIM14)
,
#endif
...
#if STM32_PWM_USE_TIM3 && (STM32_PWM_USE_TIM4 || STM32_PWM_USE_TIM14)
,
#endif
...
#if STM32_PWM_USE_TIM4 && STM32_PWM_USE_TIM14
,
#endif
