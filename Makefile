...
ALLCSRC += $(wildcard ./cmp/*.c)
ALLCSRC += $(CHIBIOS)/os/hal/lib/streams/chprintf.c
CSRC = $(ALLCSRC) 
...
INCDIR = $(CONFDIR) $(ALLINC) $(TESTINC) ./cmp ./src $(CHIBIOS)/os/hal/lib/streams
...
dfu-flash:
	...
	dfu-util  -d 0a5c:217f -a 0 --dfuse-address 0x08000000 -D ./build/$(PROJECT).bin #Flash using dfu-util
